...
export function getSocket(): Socket {
  ...
  // Guard: socket.io-client uses browser APIs — never run on the server
  if (typeof window === "undefined") {
    throw new Error("getSocket() called outside of browser context");
  }

  // Dynamic import keeps the socket.io bundle out of the server render
